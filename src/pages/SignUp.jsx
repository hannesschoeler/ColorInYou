...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!error) {
      window.location.href = 'https://colorinyou.de';
    } else {
      setLoading(false);
    }
  };
    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-8rem)] bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-playful text-3xl font-bold text-gray-800">Erstelle dein Konto</h1>
          <p className="text-gray-600">Werde Teil der ColorInYou-Familie!</p>
        </div>
